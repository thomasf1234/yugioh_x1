...
module ExternalPages
  ...
  class MainPage
    ...
    def initialize(card_name)
      @page = Nokogiri::HTML(open("#{ExternalPages::YUGIOH_WIKIA_URL}/wiki/#{card_name}"))
    ...
    def gallery_page
      ...
      @gallery_page ||= GalleryPage.new(Nokogiri::HTML(open(YUGIOH_WIKIA_URL + gallery_end_point)))
    end
  end
end
